...
public class PresenceController {
    ...
    @PostMapping("/save")
    public ResponseEntity<PresenceDto> savePresence(@RequestBody PresenceDto presenceDto){
    ...
    public ResponseEntity<PresenceDto> updatePresence(@PathVariable Long id ,@RequestBody PresenceDto presenceDto) throws NotFoundException {
